...
function Card({
  ...
  return /* @__PURE__ */ jsxs2("div", { className: cardClasses, style: getCardStyle(), ...rest, children: [
    ...
    description && /* @__PURE__ */ jsx2("p", { className: "text-sm text-white dark:text-gray-400 mb-4", children: description }),
    /* @__PURE__ */ jsx2("div", { className: "text-white dark:text-gray-300", children }),
